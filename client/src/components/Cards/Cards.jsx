    ...
    return (
        <div>
            <p className="consigna"> 
                NYI Cards: listado de cards con las recetas. Al iniciar deberá cargar los primeros resultados obtenidos desde la ruta GET /recipes y deberá mostrar Imagen - Nombre - Tipos de dietas.
